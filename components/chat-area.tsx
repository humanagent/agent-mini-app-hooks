        ...
        <div className="absolute inset-0 touch-pan-y overflow-y-auto">
          <div className="mx-auto flex min-w-0 max-w-4xl flex-col gap-4 px-2 py-4 md:gap-6 md:px-4">
            ...
            {messages.map((message) => (
              <div
                key={message.id}
                className="group/message is-user fade-in w-full animate-in duration-200"
              >
                <div className="flex w-full items-start gap-2 md:gap-3 justify-end">
                  <div className="flex flex-col gap-2 md:gap-4 max-w-[calc(100%-2.5rem)] sm:max-w-[min(fit-content,80%)]">
                    <div className="flex flex-col gap-2 overflow-hidden text-sm group-[.is-user]:bg-primary group-[.is-user]:text-primary-foreground group-[.is-assistant]:bg-secondary group-[.is-assistant]:text-foreground w-fit break-words rounded-2xl px-3 py-2">
